...
export default function CategoryDeleteButton({ categoryKey, categoryName }: { categoryKey: string, categoryName: string }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      // If success, it redirects via Server Action, so we don't need to do anything else.
    } catch (err: any) {
            ...
            >
              {errorMsg ? (
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-500 text-sm mb-8 leading-relaxed">
                    Are you sure you want to delete <span className="font-bold text-gray-900">"{categoryName}"</span>? 
                    <br/><br/>
